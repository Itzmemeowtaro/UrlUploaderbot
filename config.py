...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7961888195:AAFk7fFOKDtybDb3FFJuZbLxttlAM1Wt6eY")
    ...
    LAZY_DEVELOPER = set(int(x) for x in os.environ.get("LAZY_ADMIN", "-6440021089").split())
